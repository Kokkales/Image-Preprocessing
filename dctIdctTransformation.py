...
if __name__=='__main__':
    ...
    plt.subplot(132), plt.imshow(idct_result.astype(np.uint8), cmap='gray'), plt.title('Reconstructed Image')
    plt.subplot(133), plt.imshow(dct_spectrum), plt.title('DCT Spectrum')
